            ...
            <div className="bg-white p-6 rounded-3xl border border-slate-100 shadow-md space-y-4 flex-1 text-left relative overflow-hidden">
              ...
              <div className="flex gap-3.5 items-start">
                ...
                <div className="space-y-1">
                  ...
                  <h3 className="font-extrabold text-slate-900 text-base leading-tight">+91 81710 69007 / +91 63986 82424</h3>
                  <p className="text-slate-600 text-xs">
                    Order catering, bulk sweet boxes, or book fine dining tables directly over phone or WhatsApp.
                  </p>
                </div>
              </div>
              ...
              <div className="flex flex-wrap gap-2 pt-2">
                <a
                  ...
                  className="flex-1 min-w-[100px] bg-slate-900 hover:bg-slate-800 text-white text-center text-xs font-bold py-2.5 px-3 rounded-xl transition cursor-pointer flex items-center justify-center gap-1"
                >
                  Call Store
                </a>
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="flex-1 min-w-[125px] bg-[#25D366] hover:bg-[#1ebd59] text-white text-center text-xs font-bold py-2.5 px-3 rounded-xl transition flex items-center justify-center gap-1.5 cursor-pointer shadow-sm"
                >
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="flex-1 min-w-[125px] bg-[#128C7E] hover:bg-[#0e7065] text-white text-center text-xs font-bold py-2.5 px-3 rounded-xl transition flex items-center justify-center gap-1.5 cursor-pointer shadow-sm"
                >
                  <svg className="w-4 h-4 fill-current shrink-0" viewBox="0 0 24 24">
                    <path d="M.057 24l1.687-6.163c-1.041-1.804-1.588-3.849-1.587-5.946C.06 5.348 5.397.01 12.008.01c3.202.001 6.212 1.246 8.477 3.514 2.266 2.268 3.507 5.28 3.505 8.484-.004 6.657-5.34 11.997-11.953 11.997-2.005-.001-3.973-.502-5.724-1.455L0 24zm6.59-4.846c1.6.95 3.188 1.449 4.825 1.451 5.436 0 9.86-4.37 9.864-9.799.002-2.63-1.023-5.101-2.885-6.968C16.628 1.97 14.161.944 11.54.944c-5.44 0-9.866 4.369-9.87 9.8.002 2.042.547 4.039 1.584 5.787L2.176 21.6l5.221-1.354z" />
                  </svg>
